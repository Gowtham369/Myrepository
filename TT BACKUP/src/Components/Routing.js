...
import Scorer from './Matches/Scorer'
import Fixtures from './Matches/Fixtures';
import Updatemyprofile from './Loginandsignup/Updatemyprofile';
export default function Routing() {
  ...
  <Route exact path='/Tournamentdetails/:id/Createdraws/Matches' component={Matches}></Route> 
  <Route exact path='/Tournamentdetails/:tournamentid/Createdraws/Matches/:matchid' component={Scorer}></Route> 
...
{/* My Profile */}
     ...
     <Route exact path='/Myprofile/Addmoredetails' strict component={Updatemyprofile}></Route> 
